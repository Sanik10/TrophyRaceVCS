...
public class Axle : MonoBehaviour {
	...
	[SerializeField] Transform LeftWheelController;					//Left WheelCollider ref
	[SerializeField] Transform RightWheelController;				//Right WheelCollider ref
	...
	[SerializeField] Vector3 LeftWorldPosition;						//For getting position from LeftWheelCollider
	[SerializeField] Vector3 RightWorldPosition;					//For getting position from RightWheelCollider
	...
	private void FixedUpdate () {
		...
		LeftWorldPosition = LeftWheelPosition = LeftWheelController.position;
		RightWorldPosition = RightWheelPosition = RightWheelController.position;
		...
		LeftWheelView.localRotation = Quaternion.Euler(LeftWheelController.rotation.x, 0f, 0f);
		RightWheelView.localRotation = Quaternion.Euler(RightWheelController.rotation.x, 0f, 0f);
	}
}
*/
